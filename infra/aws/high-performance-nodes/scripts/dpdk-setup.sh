...
# Sentinel: SR-IOV CNI installation is now handled securely by the sriov-cni-installer DaemonSet
# The insecure host-level download script has been removed
log "SR-IOV CNI will be installed by the sriov-cni-installer-x86 DaemonSet (using pinned container images)"
